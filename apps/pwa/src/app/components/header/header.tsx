...
import HeartIocn from "../../../assets/heart.svg";
...
export default function Header() {
  ...
  return (
    <>
      <nav
        className="primary-color border-gray-200 px-2 sm:px-4 py-2.5  justify-center items-center"
      ...
      >
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className="flex md:order-2">
            <button
              ...
              type="button"
              className="bg-white inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-white focus:outline-none focus:ring-2 focus:bg-white dark:text-gray-400 dark:hover:bg-white dark:focus:ring-gray-600"
        ...
        ></img>
          ...
          <Link to="/cart">
                  <a
                    className="block py-2 pr-4 pl-3 text-gray-700 border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                    onClick={() => openMenu(!isOpen)}
